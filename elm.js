...
var $author$project$Main$Model = F2(
	function (screensize, frames) {
		return {frames: frames, screensize: screensize};
	});
...
var $author$project$Main$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeSize, flags);
	if (_v0.$ === 'Ok') {
		var screensize = _v0.a;
		return _Utils_Tuple2(
			A2($author$project$Main$Model, screensize, _List_Nil),
			$elm$core$Platform$Cmd$none);
	} else {
		var err = _v0.a;
		var _v1 = A2($elm$core$Debug$log, 'it is all lost', err);
		return _Utils_Tuple2(
			A2(
				$author$project$Main$Model,
				A2($author$project$Main$ScreenSize, 0, 0),
				_List_Nil),
			$elm$core$Platform$Cmd$none);
	}
};
var $author$project$Main$FrameReceived = function (a) {
	return {$: 'FrameReceived', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$sendFrame = _Platform_incomingPort('sendFrame', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$sendFrame($author$project$Main$FrameReceived)
			]));
};
var $author$project$Main$Frame = F5(
	function (f1, f2, f3, f4, f5) {
		return {f1: f1, f2: f2, f3: f3, f4: f4, f5: f5};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Main$decodeFrame = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$Frame,
	A2($elm$json$Json$Decode$field, 'f1', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'f2', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'f3', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'f4', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'f5', $elm$json$Json$Decode$float));
...
var $author$project$Main$scrollingList = F2(
	function (frame, list) {
		var n = $elm$core$List$length(list);
		return (n > 25) ? _Utils_ap(
...
var $author$project$Main$update = F2(
	function (message, model) {
		var val = message.a;
		var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeFrame, val);
		if (_v1.$ === 'Ok') {
			var frame = _v1.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						frames: A2($author$project$Main$scrollingList, frame, model.frames)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var err = _v1.a;
			var _v2 = A2($elm$core$Debug$log, 'json parse failed', err);
...
var $author$project$Main$view = function (model) {
	var rect = A2(
		...
		A2($timjs$elm_collage$Collage$rectangle, model.screensize.width, model.screensize.height));
	var props = A2(
		$elm$core$String$join,
		' ',
		_List_fromArray(
			[
				'width:',
				$elm$core$String$fromInt(model.screensize.width),
				'height:',
				$elm$core$String$fromInt(model.screensize.height)
			]));
	var circ = F2(
		function (color, _v0) {
			var x = _v0.a;
	...
	var graphAll = function () {
		var scaleVertical = function (y) {
			return (y * model.screensize.height) - (model.screensize.height / 2.0);
		};
		var n = $elm$core$List$length(model.frames);
		var frameSlice = F2(
			function (idx, frame) {
				var y5 = scaleVertical(frame.f5);
				var y4 = scaleVertical(frame.f4);
				var y3 = scaleVertical(frame.f3);
				var y2 = scaleVertical(frame.f2);
				var y1 = scaleVertical(frame.f1);
				var x = ((idx / n) * model.screensize.width) - (0.5 * model.screensize.width);
				return _List_fromArray(
					[
						A2(
						circ,
		...
		return $elm$core$List$concat(
			A2($elm$core$List$indexedMap, frameSlice, model.frames));
	}();
	return A2(
		$elm$html$Html$div,
		_List_Nil,
